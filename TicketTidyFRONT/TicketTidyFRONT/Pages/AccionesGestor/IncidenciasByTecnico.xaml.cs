    ...
    public async Task CargarIncidencias()
    {
        ...
        try
        {
            ...
            var incidenciasHTTP = await HTTPHelper.GetAll<Incidencia>(
                "http://tickettidy.somee.com/getIncidenciasTotalesByTecnico/{id}?idtecnico=" + idTecnico
            );
        ...
        try
        {
            ...
            if(incidencia != null)
            {
                DisplayAlert("Info",
                    ...
                    "Fecha Apertura: " + incidencia.FechaDeApertura + "\n" + "\n" +
                    "Descripcion: " + incidencia.DescripcionDeLaIncidencia + "\n" + "\n" +
