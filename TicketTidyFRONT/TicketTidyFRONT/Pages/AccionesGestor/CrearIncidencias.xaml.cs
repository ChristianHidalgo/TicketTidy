    ...
    private async void saveBtn_Clicked(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                incidencia.FechaDeApertura = DateOnly.FromDateTime(pickerFecha.Date);
                incidencia.Estado = "Alta";
                incidencia.DescripcionDeLaIncidencia = descripcionEntry.Text;
                ...
                incidencia.TipoDeIncidencia = null;
